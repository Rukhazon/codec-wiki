...
| `YUV420P10` | `yuv420p10le`, `yuv420p10be`                                                | luma, chroma blue, chroma red, 10 bits per component, planar, 4:2:0 subsampling                       |
| `YUV422P10` | `yuv422p10le`, `yuv422p10be`                                                | luma, chroma blue, chroma red, 10 bits per component, planar, 4:2:2 subsampling                       |
| `YUV444P10` | `yuv444p10le`, `yuv444p10be`                                                | luma, chroma blue, chroma red, 10 bits per component, planar, no subsampling                          |
